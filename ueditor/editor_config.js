...
(function () {
    ...
    UEDITOR_CONFIG = {
        ...
        filePath:URL + "ueditor/server/upload/",  //附件文件夹保存路径
	    catchRemoteImageEnable:true,                                   //是否开启远程图片抓取
        catcherUrl:URL +"ueditor/server/submit/php/getRemoteImage.php",             //处理远程图片抓取的地址
        localDomain:"http://localhost/aqadmin",                                        //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地
